...
class MasterDbControllerTest {
    ...
    void testList_WithSearchKeyword() throws Exception {
        ...
        mockMvc.perform(get("/masterdb/").param("keyword", "Y123"))
                .andExpect(status().isOk());
    ...
    void testDelete() throws Exception {
        mockMvc.perform(post("/masterdb/delete").param("id", "1").with(csrf()))
                .andExpect(status().is3xxRedirection())
                .andExpect(flash().attributeExists("success"));
    ...
    void testDownloadTemplate() throws Exception {
        ...
        mockMvc.perform(get("/masterdb/template"))
                .andExpect(status().isOk())
