...
public class SecurityConfig {
        ...
        public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
                http.authorizeHttpRequests((authorize) -> authorize.requestMatchers("/register/**")
                                                ...
                                                .requestMatchers("/entry/edit", "/entry/admin-delete", "/entry/delete").hasAnyRole("ADMIN", "MANAGER")
                                                .requestMatchers("/split-entry/delete/**").hasAnyRole("ADMIN", "MANAGER")
                                                .requestMatchers("/split-entry/output", "/split-entry/output/**").hasAnyRole("ADMIN", "MANAGER")
                                                .requestMatchers("/split-entry/articles", "/split-entry/articles/**").hasAnyRole("ADMIN", "MANAGER")
