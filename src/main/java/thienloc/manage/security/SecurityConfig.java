...
public class SecurityConfig {
        ...
        public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
                http.authorizeHttpRequests((authorize) -> authorize.requestMatchers("/register/**")
                                ...
                                .requestMatchers("/masterdb/**").hasAnyRole("ADMIN", "MANAGER")
                                ...
                                .requestMatchers("/entry/**").hasAnyRole("ADMIN", "MANAGER")
                                .requestMatchers("/notifications/**").hasAnyRole("ADMIN", "MANAGER")
                                .requestMatchers("/eff-config/**").hasAnyRole("ADMIN", "MANAGER")
                                .requestMatchers("/weekly-tracking/sixs/**", "/weekly-tracking/reprocess/**")
                                .hasAnyRole("ADMIN", "MANAGER")
                                .requestMatchers("/weekly-tracking/**").hasAnyRole("ADMIN", "MANAGER")
                                .requestMatchers("/new-style/**").hasAnyRole("ADMIN", "MANAGER")
                                .requestMatchers("/salary/**").hasAnyRole("ADMIN", "MANAGER")
